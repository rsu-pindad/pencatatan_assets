...
$import = function () {
    ...
    try {
        ...
        $this->reset();
        return $this->dispatch('infoNotifikasi', title: 'Tipe', description: 'Data Tipe berhasil diimport', icon: 'success');
    } catch (\Throwable $th) {
...
on([
    'downloadImport' => function () {
        try {
            $path = config('app.import_template_tipe');
...
<div>
  <x-wireui-modal name="importModal"
                  blur="base">
    <x-wireui-card title="Import Tipe">
