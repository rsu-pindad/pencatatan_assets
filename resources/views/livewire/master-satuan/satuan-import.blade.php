...
$import = function () {
    ...
    try {
        ...
        $this->reset();
        return $this->dispatch('infoNotifikasi', title: 'Satuan', description: 'Data Satuan berhasil diimport', icon: 'success');
    } catch (\Throwable $th) {
...
on([
    'downloadImport' => function () {
        try {
            $path = config('app.import_template_satuan');
...
<div>
  <x-wireui-modal name="importModal"
                  blur="base">
    <x-wireui-card title="Import satuan">
