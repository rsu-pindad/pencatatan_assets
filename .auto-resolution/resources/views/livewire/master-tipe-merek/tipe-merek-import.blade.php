...
$import = function () {
    ...
    try {
        ...
        $this->reset();
        return $this->dispatch('infoNotifikasi', title: 'TipeMerek', description: 'Data TipeMerek berhasil diimport', icon: 'success');
    } catch (\Throwable $th) {
...
on([
    'downloadImport' => function () {
        try {
            $path = config('app.import_template_tipemerek');
...
<div>
    <x-wireui-modal name="importModal"
                  blur="base">
    <x-wireui-card title="Import tipe-merek">
