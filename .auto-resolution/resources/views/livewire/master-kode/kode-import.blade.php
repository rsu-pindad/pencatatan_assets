...
$import = function () {
    ...
    try {
        ...
        $this->reset();
        return $this->dispatch('infoNotifikasi', title: 'Kode', description: 'Data Kode berhasil diimport', icon: 'success');
    } catch (\Throwable $th) {
...
on([
    'downloadImport' => function () {
        try {
            $path = config('app.import_template_kode');
...
<div>
  <x-wireui-modal name="importModal"
                  blur="base">
    <x-wireui-card title="Import kode">
